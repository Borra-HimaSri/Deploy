...
<body>
<div class="admin-nav">
    <a href="gallery_photo_admin.php"><button>Gallery Photos</button></a>
    <a href="gallery_event_admin.php"><button>Gallery Events</button></a>
    <a href="gallery_latest_admin.php"><button>Latest Gallery</button></a>
    ...
    <?php if (isset($editRow)) { ?>
        ...
        <form action="gallery_event_admin.php" method="post">
            ...
            <label for="event_date">Event Date:</label>
            <input type="date" name="event_date" id="event_date" value="<?= $editRow['event_date'] ?>" required><br><br>
            
            <label for="event_time">Event Time:</label>
            <input type="time" name="event_time" id="event_time" value="<?= $editRow['event_time'] ?>" required><br><br>
