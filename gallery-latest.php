       ...
       <div class="modal fade" id="searchModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <div class="container py-5">
                <div class="row g-5 justify-content-center">
                    <div class="col-lg-7 col-md-12 text-center">
                        <h1 class="mb-5 display-1 text-white">Latest News</h1>
        ...
        <div class="container-fluid blog py-5">
            <div class="container py-5">
                ...
                <div class="row g-5 justify-content-center">
                    <?php
                    $result = $conn->query("SELECT * FROM images WHERE category = 'gallery-latest'"); // Fetch records for 'gallery-latest'
                            ...
                            <div class="col-md-4 wow fadeIn" data-wow-delay="0.1s">
                                <div class="blog-item rounded-bottom">
                                    <div class="blog-img overflow-hidden position-relative img-border-radius">
                                        <img src="' . $row['image_path'] . '" class="img-fluid w-100" alt="Uploaded Image" style="height: 300px; width: 100%; object-fit: cover;">
                                    </div>
                                    <div class="d-flex justify-content-between px-4 py-3 bg-light border-bottom border-primary blog-date-comments">
                                        <small class="text-dark"><i class="fas fa-calendar me-1 text-dark"></i> ' . htmlspecialchars($row['news_date']) . '</small>
                                    </div>
                                    <div class="px-4 pb-4 bg-light rounded-bottom">
                                        <div class="blog-text-inner">
                                            <a href="#" class="h4">' . htmlspecialchars($row['news_name']) . '</a>
                                            <p class="mt-3 mb-4">' . htmlspecialchars($row['news_description']) . '</p>
                                        </div>
                                    </div>
                                </div>
                            </div>';
...
<div class="col-md-6 col-lg-4 col-xl-3">
    <div class="footer-item">
        ...
        <!-- Copyright Start -->
        <!-- Copyright code remains unchanged -->
        <!-- Copyright End -->
